...
//if(navigator.userAgent.toLowerCase().indexOf("android") != -1) alert("android");
xtIPhone = navigator.userAgent.toLowerCase().indexOf("android") == -1;
if(Modernizr.history && xtIPhone) {
