...
$("html").on("donerefresh", "body", function(e, clickedSelector){
	console.log("refresh body from:"+clickedSelector);
});
$("html").on("donerefresh", "#content", function(e, clickedSelector){
	console.log("refresh content from : "+clickedSelector);
	return false;
});
$("html").on("donerefresh", "article", function(e, clickedSelector){
	console.log("refresh article from:"+clickedSelector);
	return false;
});
$("html").on("stoprefresh", "body", function(e){
	console.log("stop refresh body");
});
$("html").on("stoprefresh", "#content", function(e){
	console.log("stop refresh content");
	return false;
});
$("html").on("stoprefresh", "article", function(e){
	console.log("stop refresh article");
	return false;
});
			...
			if(options.refresh) {
				...
				currentCall= $.ajax({
		    		...
		    		.done(function(data) {
						...
						if(!insertFunction) insertFunction="html";
